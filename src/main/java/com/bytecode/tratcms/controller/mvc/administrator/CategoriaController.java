...
public class CategoriaController {
    ...
    public ModelAndView getHome( @RequestParam(defaultValue = "all", required = false) String view_name,
            @RequestParam(defaultValue = "0", required = false) int id, SpringDataWebProperties.Pageable pageable ){
    ...
    @PostMapping
    public String newAndUpdate(@ModelAttribute MCategoria MCategoria){
